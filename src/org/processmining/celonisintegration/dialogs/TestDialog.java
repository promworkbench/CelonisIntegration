...
public class TestDialog extends JPanel {
	 ...
	 */
	public TestDialog(UIPluginContext context, YourFirstInput input1, YourSecondInput input2,
			final YourParameters parameters) {
		double size[][] = { { TableLayoutConstants.FILL }, { TableLayoutConstants.MINIMUM, 30, 30 } };
		...
		ProMTextField urlField = new ProMTextField();
		ProMTextField tokenField = new ProMTextField();
...
//        myPanel.setPreferredSize(new Dimension(100,5));
		urlField.setPreferredSize(new Dimension(100,100));
        add(urlField, "0,0");
